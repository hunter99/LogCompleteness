 ...
 * <P>
 * Proposed in our paper www.bpmcenter.org/reports/BPM-10-09.pdf.
 */
@CoverageEstimator
@UnobservedClassesEstimator
public class GCPL1Estimator extends AbstractCompletenessEstimatorV1 {
	public final static double CONFIDENCE = 0.9;
	public final static double EPSILON = 0.1;

	public GCPL1Estimator() {
		this(EPSILON, CONFIDENCE);
	}

	public GCPL1Estimator(double e, double c) {
		super("GCPL1",e,c);
	}
